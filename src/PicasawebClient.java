...
private String imageFileName=null;
   ...
   */
  public PicasawebClient(PicasawebService service, String uname, String passwd, String filename) {//
    this.service = service;
    	String[] f=filename.split(" ");
    	imageFileName=f[0];// file name
    	/*
    	System.out.println("PicasawebClient filename="+filename);
     	System.out.println("PicasawebClient uname="+uname);
     	System.out.println("PicasawebClient passwd="+passwd);
     	*/
  ...
  public List<AlbumEntry> getAlbums(String username) throws IOException,
    ...
    for (@SuppressWarnings("rawtypes") GphotoEntry entry : entries) {
      @SuppressWarnings("rawtypes")
