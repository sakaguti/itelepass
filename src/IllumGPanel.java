...
public class IllumGPanel extends javax.swing.JPanel {
	/**
	...
	*/
	public static void main(String[] args) {
		...
		iconName = Path.getPath()+"/images/dt_water.jpg";
		if(IsMacorWin.isMacOrWin()==false) iconName = Path.getPath()+"images\\dt_water.jpg";
		IllumGPanel gjp=new IllumGPanel(iconName);
	...
	public IllumGPanel(String iconname) {
		super();
		initialize(iconname);
		initGUI();
	}
